...
public interface IPartContainer {
	 ...
	 */
	public ItemStack pickPart(RayTraceResult rayTrace, int part);
	
	/**
	 * Checks if a given face of this block is solid.
	 * Used to determine the result of Block.isBlockSolidOnSide.
	 */
	public boolean isPartContainerSideSolid(EnumFacing side);
	 ...
	 */
	@SideOnly(Side.CLIENT)
	public boolean addPartDestroyEffects(int part, ParticleManager effectRenderer);
	 ...
	 */
	@SideOnly(Side.CLIENT)
	public boolean addPartHitEffects(int part, EnumFacing sideHit, ParticleManager manager);
	 ...
	 */
	public RayTraceResult collisionRayTrace(Vec3d src, Vec3d dst);
