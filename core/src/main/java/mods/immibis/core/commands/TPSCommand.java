...
public class TPSCommand extends CommandBase {
	...
	public void processCommand(ICommandSender ply, String[] astring) {
		for(int nTicks : new int[] {200, 20, 5}) {
			ply.sendMessage(
				new TextComponentTranslation("mods.immibis.core.tps.avg",
					new Object[] { nTicks,
						new TextComponentTranslation("mods.immibis.core.tps.tps", new Object[]{String.format("%.2f", TickHandler.getTPS(nTicks))}),
						new TextComponentTranslation("mods.immibis.core.tps.tps", new Object[]{String.format("%.2f", TickHandler.getLowestTPS(nTicks))})
					}
				)
			);
		}
		...
		ply.sendMessage(
			new TextComponentTranslation("mods.immibis.core.tps.lastTime", new Object[] {
				new TextComponentTranslation("mods.immibis.core.tps.time", new Object[]{TickHandler.getTickTime()}),
				new TextComponentTranslation("mods.immibis.core.tps.tps", new Object[]{String.format("%.2f", TickHandler.getTPS1())})
			})
		);
	}
